...
Run: `./pipe2.exe`
    ...
    0.001     main():43  [tid=70967]: Program start
    0.001     main():89  [tid=70967]: Wait subprocesses
    0.004     main():63  [tid=70968]:   Written 65536 bytes (first letter = A)
    0.004     main():63  [tid=70968]:   Written 65536 bytes (first letter = D)
    0.004     main():83  [tid=70969]:   Read 65536 bytes (first letter = A)
    0.004     main():83  [tid=70969]:   Read 65536 bytes (first letter = D)
    0.004     main():63  [tid=70968]:   Written 65536 bytes (first letter = G)
    0.004     main():83  [tid=70969]:   Read 65536 bytes (first letter = G)
    0.004     main():63  [tid=70968]:   Written 65536 bytes (first letter = J)
    0.004     main():83  [tid=70969]:   Read 65536 bytes (first letter = J)
    0.004     main():63  [tid=70968]:   Written 65536 bytes (first letter = N)
    0.004     main():83  [tid=70969]:   Read 65536 bytes (first letter = N)
    0.004     main():63  [tid=70968]:   Written 65536 bytes (first letter = Q)
    0.004     main():83  [tid=70969]:   Read 65536 bytes (first letter = Q)
    0.004     main():63  [tid=70968]:   Written 65536 bytes (first letter = T)
    0.004     main():83  [tid=70969]:   Read 65536 bytes (first letter = T)
    0.004     main():63  [tid=70968]:   Written 41248 bytes (first letter = W)
    0.004     main():83  [tid=70969]:   Read 41248 bytes (first letter = W)
    0.004     main():92  [tid=70967]: Program finished
