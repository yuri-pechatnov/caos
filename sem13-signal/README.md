...
```
    ...
    #0  0x00007f1d51c25428 in __GI_raise (sig=sig@entry=6) at ../sysdeps/unix/sysv/linux/raise.c:54
    ...
    #1  0x00007ffff7a4402a in __GI_abort () at abort.c:89
            save_stage = 2
            act = {__sigaction_handler = {sa_handler = 0x4, sa_sigaction = 0x4}, sa_mask = {__val = {0, 1095216660480, 140737488347024, 0, 140737354096640, 4196355, 21, 4196380, 0, 0, 140737348441404, 140737349538384, 140737349552032, 0, 140737349538384, 4196355}}, sa_flags = -134258688, sa_restorer = 0x400803}
    ...
    #5  0x000000000040071c in main (argc=1, argv=0x7fffffffe1f8) at coredump.c:32
    No locals.
