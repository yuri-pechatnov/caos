...
Run: `./stand.exe`
    ...
    Bit numbers:    6         5         4         3         2         1         0
                 3210987654321098765432109876543210987654321098765432109876543210  (-1)^S * 2^(E-B) * (1+M/(2^Mbits))
                 ----------------------------------------------------------------
...
Run: `gcc -O2 -Wall bitcast.c -o bitcast.exe`
    ...
    [01m[Kbitcast.c:26:13:[m[K [01;35m[Kwarning: [m[Kdereferencing type-punned pointer will break strict-aliasing rules [[01;35m[K-Wstrict-aliasing[m[K]
       26 |     return *[01;35m[K(uint64_t*)(void*)&d[m[K; // Простое, но неоднозначное решение из-за алиасинга
          |             [01;35m[K^~~~~~~~~~~~~~~~~~~~[m[K
