...
<br> В C же к объявлению переменной приписывается _Atomic. С его исползованием есть один тонкий момент. Он осложняется отсуствием документации. Про этот тонкий момент читайте ниже.

Про атомарные функции с переменными можно посмотреть в ридинге Яковлева.
