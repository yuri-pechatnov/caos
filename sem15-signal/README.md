...
```
    ...
    #1  0x00007ffff7de2859 in __GI_abort () at abort.c:79
            save_stage = 1
            act = {__sigaction_handler = {sa_handler = 0x5555555592a0, sa_sigaction = 0x5555555592a0}, sa_mask = {__val = {58, 4, 0, 0, 0, 140737353565189, 0, 21474836480, 140737488346048, 0, 140737353596944, 0, 12022478632837123328, 140737353565189, 140737354117120, 140737353581960}}, sa_flags = 1431658504, sa_restorer = 0x18}
